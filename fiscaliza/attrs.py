    ...
    "ha_outras_fontes_interfer": FieldWithOptions(
        ...
        mapping={
            "Sim": [
                ...
                "fonte_e_modelo_1",
                "frequencia_mhz_1",
                "potencia_de_operacao_w_1",
                "distancia_ao_interferido_m_1",
                "homologada_1",
                "tipo_de_fonte_interferente_2",
                "fonte_e_modelo_2",
                "frequencia_mhz_2",
                "potencia_de_operacao_w_2",
                "distancia_ao_interferido_m_2",
                "homologada_2",
                "tipo_de_fonte_interferente_3",
                "fonte_e_modelo_3",
                "frequencia_mhz_3",
                "potencia_de_operacao_w_3",
                "distancia_ao_interferido_m_3",
                "homologada_3",
                "tipo_de_fonte_interferente_4",
                "fonte_e_modelo_4",
                "frequencia_mhz_4",
                "potencia_de_operacao_w_4",
                "distancia_ao_interferido_m_4",
                "homologada_4",
                "tipo_de_fonte_interferente_5",
                "fonte_e_modelo_5",
                "frequencia_mhz_5",
                "potencia_de_operacao_5",
                "distancia_ao_interferido_m_5",
                "homologada_5",
            ],
        },
    ),
